...
<template>
  <div class="min-h-screen bg-zinc-100 px-8 pt-24">
    <div class="mx-auto max-w-sm rounded-lg border border-zinc-50 bg-white p-8 shadow">
      <h1 class="mb-4 text-center text-2xl font-semibold text-zinc-900">New Password</h1>

      <form v-if="!success" @submit.prevent="requestPasswordReset" class="flex flex-col gap-4">
        <p class="mb-2 text-sm text-zinc-700">It must be at least 8 characters long.</p>
